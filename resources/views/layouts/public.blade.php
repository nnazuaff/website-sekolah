...
<body class="min-h-screen bg-stone-50 text-slate-900 antialiased">
    ...
    <header class="border-b border-slate-200 bg-white">
        <nav class="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8" aria-label="Navigasi utama">
            ...
            <div class="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm font-semibold text-slate-600">
                ...
                <a href="{{ route('majors.index') }}" class="transition hover:text-amber-700">Jurusan</a>
                <a href="{{ route('teachers.index') }}" class="transition hover:text-amber-700">Guru</a>
                <a href="{{ route('news.index') }}" class="transition hover:text-amber-700">Berita</a>
                <a href="{{ route('pengumuman.index') }}" class="transition hover:text-amber-700">Pengumuman</a>
                <a href="{{ route('galeri.index') }}" class="transition hover:text-amber-700">Galeri</a>
                <a href="{{ route('fasilitas.index') }}" class="transition hover:text-amber-700">Fasilitas</a>
