...
@section('content')
@include('layouts._public-page-header', ['title' => $article->title, 'description' => $article->published_at->translatedFormat('d F Y, H:i'), 'parentRoute' => 'news.index', 'parentLabel' => 'Berita'])
